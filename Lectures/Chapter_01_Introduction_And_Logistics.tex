...
\begin{frame}[containsverbatim]{Connecting Remotely to a Linux Machine for Development}
  ...
  \begin{minted}[bgcolor=powderGreen]{bash}
	ssh rkb0022@lovelace.ece.uah.edu
  \end{minted}
  
  Lovelace is our newest machine with several GPUs. Login to Lovelace requires UAH account password and Duo push for 2-factor authentication.
